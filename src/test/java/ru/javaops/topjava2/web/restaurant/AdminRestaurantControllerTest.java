...
class AdminRestaurantControllerTest extends AbstractControllerTest {
    ...
    @Autowired
    Converter<Restaurant, RestaurantTo> restaurantToConverter;
    ...
    void createWithLocation() throws Exception {
        RestaurantTo createRestaurantTo = RestaurantTestData.getNew();
        ...
        RESTAURANT_TO_MATCHER.assertMatch(restaurantToConverter.convert(service.get(created.getId())), expected);
    }
    ...
    void update() throws Exception {
        RestaurantTo updateRestaurantTo = RestaurantTestData.getUpdated();
        ...
        RESTAURANT_TO_MATCHER.assertMatch(
                restaurantToConverter.convert(service.get(updateRestaurantTo.getId())),
                expected
        );
    }
